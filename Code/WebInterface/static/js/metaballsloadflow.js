...
const presets = {
  moody: {
    ...
    specularPower: 8,
    fresnelPower: 1.2,
    backgroundColor: new THREE.Color(0x050505),  // Keep same dark background
    sphereColor: new THREE.Color(0x001122),     // Dark blue base
    lightColor: new THREE.Color(0x00B4D8),
    ...
    cursorGlowColor: new THREE.Color(0x90E0EF)
  },
  cosmic: {
...
function init() {
  const container = document.getElementById("container-loadflow");
